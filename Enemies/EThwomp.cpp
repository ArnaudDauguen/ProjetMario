...
EThwomp::EThwomp(Game* game, sf::Vector2f startingPosition, sf::Vector2f scale, float mass, int textureIndex, float playerDetectionXRange, float timeOnGround, float ascendSpeed)
{
	this->m_game = game;
